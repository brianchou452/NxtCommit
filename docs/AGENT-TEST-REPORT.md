...
> **Main integration, v0.7.20:** This report records the earlier isolated branch. Main now also contains the A/B/C scripted fixture engine. The old 54 TODO and absent-runner statements below describe that earlier snapshot, not current main.
