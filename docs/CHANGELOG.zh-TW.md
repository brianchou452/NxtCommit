...
- 代理實驗室改以測試內容、實測結果與下一步為主軸。按風險分類本輪檢查，解釋各階段分工，並將診斷細節收進可展開的證據區。保留執行、待命、斷線與來源狀態。

## v0.7.26 — 2026-09-12

- 移除首頁流程演進示例區塊，並將首頁主要按鈕恢復為探索募資提案。

## v0.7.25 — 2026-09-12

- 首頁改以任務修正與維護者確認後的儲存庫流程演進為主軸。新增九階段互動示例，保留來源、範圍、版本、明確模擬確認與下一個議題驗收。統一代理實驗室中文名稱與階段文案。本次產品呈現不代表已實作真實審查回覆擷取或正式規則執行。
